...
#
#   conflicts_with "vuldra", because: "both install `vuldra` binaries"
#
#   def install
#     system "./gradlew", "macosX64Test", "linkReleaseExecutableMacosX64"
#     bin.install "build/bin/macosX64/releaseExecutable/kotlin-cli-starter.kexe" => "vuldra"
#     bash_completion.install "completions/vuldra.bash" => "vuldra"
#     fish_completion.install "completions/vuldra.fish"
